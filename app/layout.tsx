...
export const metadata = {
  ...
  description:
    "Sanjay is a full-stack developer skilled in building web applications using MERN stack, React, Next.js, Node.js, and Tailwind CSS.",
  keywords:
    "Sanjay Balam, full-stack developer, MERN stack, React developer, portfolio, web development, software developer",
  author: "Sanjay Balam",
  viewport: "width=device-width, initial-scale=1.0",
  robots: "index, follow",
  openGraph: {
    title: "Sanjay | Personal Portfolio",
    description: "Explore Sanjay's work as a full-stack developer.",
    url: "https://your-portfolio-url.com", // Replace with your actual URL
    site_name: "Sanjay Portfolio",
    //     images: [
    //       {
